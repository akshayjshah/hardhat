...
func New(logger *log.Logger) (*Repository, error) {
...
func (r *Repository) Diff(since string) (Diff, error) {
	...
	if err != nil {
		return Diff{}, fmt.Errorf("can't find untracked files: %v", err)
	}
	...
	if err != nil {
		return Diff{}, fmt.Errorf("can't identify changed files: %v", err)
	}
